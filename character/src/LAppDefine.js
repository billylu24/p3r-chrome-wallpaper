var LAppDefine = {
    ...
    BACK_IMAGE_NAME : "assets/image/costumeBG.png",
    ...
    MODEL_SAKIKO : "assets/sakiko_model/sakiko.model.json",

    // 外部定義ファイル(json)と合わせる
    MOTION_GROUP_IDLE : "idle", // アイドリング
    MOTION_GROUP_TAP_BODY : "tap_body", // 体をタップしたとき
    MOTION_GROUP_TAP_HAND : "tap_hand", // 手をタップしたとき
    ...
    // 自定义动作情景
    MOTION_GROUP_ANGRY: "angry",
    MOTION_GROUP_BYE: "bye",
    MOTION_GROUP_CRY: "cry",
    MOTION_GROUP_KIME: "kime",
    MOTION_GROUP_NF_LEFT: "nf_left",
    MOTION_GROUP_NF_RIGHT: "nf_right",
    MOTION_GROUP_NF: "nf",
    MOTION_GROUP_NNF_LEFT: "nnf_left",
    MOTION_GROUP_NNF_RIGHT: "nnf_right",
    MOTION_GROUP_NNF: "nnf",
    MOTION_GROUP_NOD: "nod",
    MOTION_GROUP_ODOODO: "odoodo",
    MOTION_GROUP_SAD: "sad",
    MOTION_GROUP_SERIOUS: "serious",
    MOTION_GROUP_SHAME: "shame",
    MOTION_GROUP_SIGH: "sigh",
    MOTION_GROUP_SMILE: "smile",
    MOTION_GROUP_SURPRISED: "surprised",
    MOTION_GROUP_THINKING: "thinking",
